...
if(isset($_GET["id"])){
    ...
    if(isset($_POST["confirmation"]) && $_POST["confirmation"] === "yes") {
        ...
        $suppression = $clientMySQL->prepare("DELETE FROM auteur WHERE id= ?");
        $suppression->execute(array($id));

        header('location: http://sae203/administration/auteurs/');
        exit();
    ...
    echo '
        ...
        <form method="POST" action="" class="confirmation-form ">
            ...
            <div class="btn-wrapper">
                ...
                <a href="http://sae203/administration/auteurs/">NON</a>
            </div>
        </form>
    ';
}
